      ...
      <div className="relative">
        ...
        <div className="relative z-10 max-w-6xl mx-auto p-8">
          ...
          <section className="text-center mb-12">
            <h1 className="text-4xl font-bold text-white mb-6">About Rubab's Blog</h1>
            <p className="text-xl text-white leading-relaxed mx-auto max-w-3xl">
              Welcome to Rubab's Tech Blog – your destination for insightful stories, tech innovations,
          ...
          <section className="flex flex-col md:flex-row gap-12 items-center mb-16">
            ...
            <div className="md:w-1/2">
              ...
              <p className="text-lg text-white mb-6">
                At Rubab's Tech Blog, we strive to bridge the gap between innovation and inspiration. 
              ...
              <h2 className="text-3xl font-bold text-white mb-4">Why This Blog?</h2>
          ...
          <section className="py-16">
            <h2 className="text-4xl font-extrabold text-blue-600 text-center mb-6">
              Join the Journey with Rubab's Blog
            </h2>
